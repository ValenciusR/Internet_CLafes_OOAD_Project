...
public class UserHomePage {
	...
	public UserHomePage(User cu){
		initializeUserPage(cu);
	}
	...
	private void handle(UserHomeVar userHomeVar, User cu) {
		UserPageController userPageController = new UserPageController();
		userPageController.changeHomeMenuPage(userHomeVar, cu);
	}
	
	public Scene initializeUserPage(User cu){
		// TODO Auto-generated method stub
		UserHomeVar userHomeVar = new UserHomeVar();
		initialize(userHomeVar);
		handle(userHomeVar, cu);
