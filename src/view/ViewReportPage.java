...
public class ViewReportPage {
	...
	private void handle(ViewReportVar viewReportVar, LoginVar lv) {
		...
		adminPageController.changeViewReportPage(viewReportVar, lv);
	}
	
	
	public Scene initializeViewReportPage(LoginVar lv){
		// TODO Auto-generated method stub
		ViewReportVar viewReportVar = new ViewReportVar();
		initialize(viewReportVar);
		handle(viewReportVar, lv);
