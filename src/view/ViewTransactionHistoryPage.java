...
public class ViewTransactionHistoryPage {
	...
	private void handle(ViewTransactionHistoryVar viewTransactionHistoryVar, LoginVar lv) {
		...
		adminPageController.changeViewTransactionHistoryPage(viewTransactionHistoryVar, lv);
	}
	
	
	public Scene initializeViewTransactionHistoryPage(LoginVar lv){
		...
		handle(viewTransactionHistoryVar, lv);
